...
```bash
pip install jupyter_engagement_helper
```
...
```bash
pip uninstall jupyter_engagement_helper
```
...
# Change directory to the jupyter_engagement_helper directory
...
folder is located. Then you can remove the symlink named `jupyter-engagement-helper` within that folder.
